...
contract DiaNFT {
   ...
   */
    ...
    mapping (bytes32 => TokenData) public data; // what would be 'key'?! it would be sort of serial number for one DiaNFT
    ...
    function mint ( bytes32 _owner, string memory _girdleCode, 
                    bytes32 _anchor, bytes32 _data_root, bytes32 _signature_root,
                    uint[8] memory points) public returns (bytes32) {
        ...
        // Generate a serial number for the requested DiaNFT..
            // Option #1 . Merkle Tree of NFTs..
    }
